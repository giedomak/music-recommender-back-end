...
import com.crawler.toplist.objects.User;
import com.crawler.toplist.objects.UserPlaylist;
...
public class SpotifyUserPlaylistCrawler {
	...
	public void Start(String userId) {
		try {
			...
			UserPlaylist playlists = gson.fromJson(content,com.crawler.toplist.objects.UserPlaylist.class);
			...
			for(com.crawler.toplist.objects.PlaylistSimple item : playlists.getItems()) {
